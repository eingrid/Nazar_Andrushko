...
namespace WebAPI_2.StepDefinitions
{
    public class API_INT
    {
        ...
        private IRestResponse getList_Folder_response(){
            ...
            requestCheck.AddHeader("Authorization", "Bearer sl.A-hmLfSfjVSiqdmy1BK1zb7Sb5zOKRnDaJO656BIRVq4QvOCZ68PBCjoubDmPAeG8KSabiXEkdLhxu_5K8AWidfzsLRDbLMbwziUGDXzU1TLTel0BCteFbII_mTG65X-a-bVPOOuPnX3");
        ...
        public void sendRequestToUploadFIle()
        {
            ...
            requestUpload.AddHeader("Authorization", "Bearer sl.A-hmLfSfjVSiqdmy1BK1zb7Sb5zOKRnDaJO656BIRVq4QvOCZ68PBCjoubDmPAeG8KSabiXEkdLhxu_5K8AWidfzsLRDbLMbwziUGDXzU1TLTel0BCteFbII_mTG65X-a-bVPOOuPnX3    ");
        ...
        {
            requestDelete.AddHeader("Authorization", "Bearer sl.A-hmLfSfjVSiqdmy1BK1zb7Sb5zOKRnDaJO656BIRVq4QvOCZ68PBCjoubDmPAeG8KSabiXEkdLhxu_5K8AWidfzsLRDbLMbwziUGDXzU1TLTel0BCteFbII_mTG65X-a-bVPOOuPnX3");
        ...
        {
            requestGetMeta.AddHeader("Authorization", "Bearer sl.A-hmLfSfjVSiqdmy1BK1zb7Sb5zOKRnDaJO656BIRVq4QvOCZ68PBCjoubDmPAeG8KSabiXEkdLhxu_5K8AWidfzsLRDbLMbwziUGDXzU1TLTel0BCteFbII_mTG65X-a-bVPOOuPnX3");
